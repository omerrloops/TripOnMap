    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed bottom-[140px] right-4 z-[1000] w-14 h-14 flex items-center justify-center ${showRoute ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-gray-600 hover:bg-gray-700'} text-white rounded-full shadow-lg transition-all hover:scale-110`}
            ...
            {/* Map Style Toggle */}
            <div className="fixed bottom-[210px] right-4 z-[1000]">
                {isStyleMenuOpen && (
